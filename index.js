...
function Library () {
    ...
    Library.prototype.renderBook = function(book) {
        ...
        // need to increment book id in constructor (factory method) and update library to render
function Book(title, author, pages, read) {
    Book.prototype.id++;
    this.book_id = Book.prototype.id;  
    this.title = title;
    this.author = author;
    this.pages = pages;
